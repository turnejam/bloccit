...
RSpec.describe AdvertisementsController, type: :controller do
  ...
  let(:my_advertisement) { Advertisement.create!(title: RandomData.random_sentence, copy: RandomData.random_paragraph, price: 20) }
  ...
  describe "GET #index" do
    ...
    it "assigns [my_advertisement] to @posts" do
       get :index
